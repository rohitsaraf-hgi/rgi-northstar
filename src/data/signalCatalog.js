...
export const SIGNAL_CATALOG = [
  ...
  // ─── Buyer Intent ────────────────────────────────────────────────────
  {
    ...
    source: 'HG data',
    description: 'TrustRadius Intent — active buying cycle',
    detectionRule: 'TrustRadius intent record within last 14 days',
    nba: {
      verb: 'Draft peer-comparison outreach',
      agent: 'draft_personalized_email',
      guidance: 'They are currently in an active buying cycle. Reach out ASAP, referencing peer reviews from their industry. Provide a proof point such as a case study or reference call.',
    },
    weight: 50,
    attentionEligible: true,
  },
  {
    ...
    category: 'buyer_intent',
    source: 'HG data',
    description: 'Topic Intent — elevated intent score on tenant-relevant topics',
    detectionRule: 'Intent score above threshold for tenant-configured topics',
    nba: {
      verb: 'Draft topic-specific outreach',
      agent: 'draft_personalized_email',
      guidance: 'Reach out with content tailored to the specific research topic. Lead with education rather than a pitch. Offer a relevant guide or a brief call framed as "we specialize in this."',
    },
    weight: 45,
    attentionEligible: true,
    tenantContextRequired: true,
  ...
  // ─── Competitive (HG) ────────────────────────────────────────────────
  {
    ...
    source: 'HG data',
    description: 'Competitive Product Install Detected',
  ...
  },
  {
    ...
    category: 'competitive',
    source: 'HG data',
    description: 'Competitive Product Momentum — Increasing',
  ...
  },
  {
    ...
    category: 'competitive',
    source: 'HG data',
    description: 'Competitive Product Momentum — Decreasing',
  ...
  },
  {
    ...
    category: 'competitive',
    source: 'HG data',
    description: 'Competitor Renewal Window Opens',
  ...
  // ─── Partner (HG) ────────────────────────────────────────────────────
  {
    ...
    category: 'partner',
    source: 'HG data',
    description: 'Partner Product Install Detected',
    detectionRule: 'HG installs contain a tenant-configured partner product',
    nba: {
      verb: 'Draft integration email',
      agent: 'draft_personalized_email',
      guidance: 'Lead with the integration story. Draft an email: "You just added [Partner] — here\'s how [Your Product] integrates with it natively."',
    },
    weight: 40,
    attentionEligible: true,
    tenantContextRequired: true,
  ...
  // ─── Product Momentum (HG) ───────────────────────────────────────────
  {
    ...
    category: 'momentum',
    source: 'HG data',
    description: 'Tenant Product Momentum — Increasing / Decreasing',
  ...
  // ─── 1P Activity ─────────────────────────────────────────────────────
  {
    ...
    description: 'Sales Activity Detected in last 7 days',
    detectionRule: 'Sales activity event within last 7 days',
    nba: {
      verb: 'View 1P activity',
      agent: null,
      guidance: 'Take them to the 1P activities tab in Company to see the underlying interaction.',
    },
    weight: 30,
    attentionEligible: false,
  },
  {
    ...
    category: 'first_party_activity',
    source: '1P Data Pipeline',
    description: 'Web Activity Detected in last 7 days',
    detectionRule: 'Web activity event within last 7 days',
    nba: {
      verb: 'Draft interest-based outreach',
      agent: 'draft_personalized_email',
      guidance: 'Draft outreach referencing their area of interest (e.g. pricing page = high intent, product page = research). Combine with HG intent signals for a stronger opening.',
    },
    weight: 35,
    attentionEligible: true,
  },
  {
    ...
    category: 'first_party_activity',
    source: '1P Data Pipeline',
    description: 'Marketing Activity Detected in last 7 days',
