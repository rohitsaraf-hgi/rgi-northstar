...
const PENDING_CHECKPOINTS_BY_PERSONA = {
  ...
  alex: [
    ...
    // Checkpoints tied to Alex's seeded plays — light up the "waiting
    // approval" chip on each play card on the Daily Brief.
    {
      id: 'chk-alex-jpmc',
      workflow_id: 'wf-tpl-prospecting-agent',
      workflow_name: 'Q3 Prospecting · Banking',
      play_id: 'play-full-prospecting-q3',
      step_label: 'AE approval — draft outreach for buying committee',
      account_id: 'acct-stripe',
      account_name: 'Stripe',
      account_logo: '#635bff',
      assignee_role: 'AE',
      bound_signal_id: null,
      bound_signal_label: null,
      fired_at: hoursAgo(2),
      sla_hours: 24,
      preview: {
        title: 'Subject: CNAPP consolidation — worth a 20-min compare?',
        snippet: 'Hi Sarah, wanted to share a fintech-specific angle on how peers are trimming vendor sprawl...',
      },
    },
    {
      id: 'chk-alex-block',
      ...
      sla_hours: 24,
      preview: {
        title: 'Subject: Runtime security at Block\'s scale',
        snippet: 'Hi James, noticed you rolled out Kubernetes at scale — we\'ve helped fintechs your size ship a runtime layer that pairs...',
      },
    },
    {
      id: 'chk-alex-contacts-1',
      workflow_id: null,
      workflow_name: 'Contact Outreach · July Saved',
      play_id: 'play-contact-outreach-jul',
      step_label: 'Batch approval — 4 personalized email drafts ready',
      account_id: 'acct-jpmc',
      account_name: '4 contacts across 3 accounts',
      account_logo: '#0F4D9F',
      assignee_role: 'AE',
      bound_signal_id: null,
      bound_signal_label: null,
      ...
      sla_hours: 48,
      preview: {
        title: 'Subject: Sarah — the CNAPP angle for JPMC',
        snippet: 'Hi Sarah, saw your recent talk on cloud-native security governance at JPMC — the way you framed platform-team ownership of runtime resonates with what we\'re seeing across peer banks...',
      },
    },
  ],
};
